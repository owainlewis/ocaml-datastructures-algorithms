...
(* OASIS_START *)
(* DO NOT EDIT (digest: 0eaba742e2aec6627c6ea4034d47f505) *)
(*
...
let setup_t =
  {
     ...
     package =
       {
          ...
          alpha_features = [];
          beta_features = [];
          name = "OCaml Data Structures and Algorithms";
          version = "1.0";
          license =
          ...
          homepage = None;
          synopsis = "OCaml Data structure and Algorithms";
          description = None;
          categories = [];
            ...
            [
               ...
               Test
                 ({
                   ...
                   {
                      test_type = (`Test, "Custom", Some "0.0.1");
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "É\t}\144Ì®#dÿ(/\147µwÊl";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
